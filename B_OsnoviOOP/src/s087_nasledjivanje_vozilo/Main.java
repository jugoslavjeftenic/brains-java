...
public class Main {
	...
	/*
	 * Prethodne klase testirati kreiranjem dva objekta klase Osoba (iz prethodnog primera),
	 * i po jednog objekta klase Automobil, Kamion i Motocikl.
	 * Potom odstampati podatke o kreiranim objektima i izvrsiti prenos vlasnistva svakog
