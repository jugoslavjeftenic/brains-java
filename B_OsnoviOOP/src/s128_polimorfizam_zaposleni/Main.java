...
public class Main {
	...
	/*
	 * Realizovati klase Nastavnik, Asistent i NenastavniRadnik, izvedene nasledjivanjem iz klase Zaposleni.
	 ...
	 * Za svaku od klasa realizovati metodu predstaviSe i racunajPlatu uzimajuci u obzir
	 * specificne atributa za svaku od klasa.
	 * Napomena: platu za nastavnike racunati kao 60000 + brojSCIRadova * 3000,
	 * kod asistenata kao 40000 + godinaDoktorskihStudija * 2000,
	 * a kod nenastavnih radnika kao 30000 + godineStaza * 500.
	 * 
	 * Klase testirati kreiranjem vise objekata u glavnom programu i
	 * pozivanjem metoda za predstavljanje i racunanje plate.
	 */
