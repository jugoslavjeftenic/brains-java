...
public class Main {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < nastavnici.length; i++) {
			nastavnici[i] = new Nastavnik(RADE.generisiIme(0), RADE.generisiPrezime(),
					RADE.generisiZanimanje(1), RADE.mrRobot(1, 5));
		...
		for (int i = 0; i < radnici.length; i++) {
			radnici[i] = new NenastavniRadnik(RADE.generisiIme(0), RADE.generisiPrezime(),
					RADE.generisiZanimanje(0), RADE.mrRobot(1, 30));
			System.out.printf("%2d. ", i + 1);
