...
public class Main {
	...
	public static void main(String[] args) {
		...
		/*
		 * strana 70: Realizovati klasu Osoba i potomak klasu Zaposleni. Klase testirati
		 * kreiranjem dva objekta klase Zaposleni u glavnom programu. Potom odstampati
		 * podatke o zaposlenima i izraèunati i odstampati njihovu platu pozivom
		 * odgovarajuæih metoda.
		 */
		...
		/*
		 * strana 80: Dodati i dva objekta klase Student u glavnom programu. Potom
		 * odstampati podatke i o studentima i izracunati i odstampati prosecan broj
		 * poena koje su osvojili pozivom odgovarajuæih metoda.
		 */
		...
		/*
		 * strana 86: Kreirati dva objekta klase Klijent u glavnom programu. Potom
		 * odstampati osnovne podatke o klijentima. Zatim izvrsiti transfer sa racuna
		 * jednog klijenta na racun drugog klijenta. Prikazati stanja racuna klijenata
		 * pre i posle transfera pozivom odgovarajuæih metoda.
		 */
		...
		System.out.printf("Sa racuna %s %s prebacujemo 1234 dukata na racun %s %s\n",
				klijenti[0].getIme(), klijenti[0].getPrezime(), klijenti[1].getIme(), klijenti[1].getPrezime());
