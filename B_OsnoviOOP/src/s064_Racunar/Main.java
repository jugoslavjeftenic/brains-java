...
public class Main {
	...
	/*
	 * Stvoriti klasu Racunar sa atributima oznakaProcesora (tipa String), radniTakt
	 * (tipa double), kapacitetMemorije (tipa int), standardnim konstruktorom i
	 * konstruktorom koji postavlja inicijalne vrednosti, pristupnim metodama (get i
	 * set) za sve atribute, kao i metodom za raèunanje indeksa performansi raèunara
	 * po formuli: indeksPerformansi = 100*radniTakt + kapacitetMemorije.
	 * Implementirati i metod za prikaz indeksa performansi raèunara u konzoli.
	 * Potom testirati klasu stvaranjem sedam objekata u okviru metode main. Nakon
	 * stvaranja objekata primenom konstruktora, potrebno je izraèunati i prikazati
